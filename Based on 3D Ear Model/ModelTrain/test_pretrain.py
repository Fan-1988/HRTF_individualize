...
def test_pretrain():
    ...
    # 数据加载
    mesh_dir = '/data1/zym/dataset/CHEDAR/3Dmesh'
    csv_file = '/data1/zym/dataset/CHEDAR/AntrhopometricMeasures/AntrhopometricMeasures.csv'
    ...
    for epoch in range(num_epochs):
        ...
        if val_loss < best_val_loss:
            ...
            patience_counter = 0
            # Save the best model
            torch.save(model.feature_extraction.state_dict(), '/data1/zym/hrtf_prediction/test/results/feature_extraction_best_params.pth')
...
class PretrainModel(nn.Module):
    def __init__(self):
        ...
        self.feature_extraction = generate_model(n_input_channels=1, conv1_t_size=3, conv1_t_stride=1, no_max_pool=True, n_classes=2522, n_classes2=2048)
