...
class UNet(nn.Module):
    def __init__(self):
        ...
        self.fc2 = nn.Linear(8, 8 * 936)  # Further expand from (129, 1, 8) to (129, 1250, 8)
        ...
        self.deconv5 = self._deconv_block(64, 1, kernel_size=(33, 5), stride=(2, 1), padding=(16, 2),output_padding=(1, 0))
    ...
    def forward(self, generic_hrtf, anthropometric):
        ...
        anthropometric = self.fc2(anthropometric).view(batch_size, 129, 936, 8)
...
if __name__=="__main__":
    batch_size = 4  # 设置批大小
    hrtf = torch.randn(batch_size, 1,936,129)
